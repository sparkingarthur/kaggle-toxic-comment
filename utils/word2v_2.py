...
from keras.layers import Dense, Input, LSTM, Embedding, Dropout, Activation,GRU,Conv1D,GlobalMaxPool1D,MaxPooling1D
...
for word, i in word_index.items():
    ...
    else: #try to init the embedding randomly
...
#conv = Conv1D(filters=200,kernel_size=3,padding='valid',activation='relu')(embedded_sequences)
...
STAMP = 'lstm-attention_word2vector-r_%.2f_%.2f' % (rate_drop_lstm, rate_drop_dense)
print(STAMP)
