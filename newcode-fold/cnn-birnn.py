...
def buildmodel():
    ...
    merged1 = Bidirectional(CuDNNGRU(128))(merged)
    merged2 = Bidirectional(CuDNNGRU(128, go_backwards=True))(merged)
    merged = keras.layers.concatenate([merged1, merged2])
...
for i in range(Kfold):
    ...
    if len(r) == 0:
        ...
        r += cv_models[i].predict(test_data,batch_size=2048)
r /= Kfold
index = 'cnn-birnn-'+str(loadvector)+'-10-fold-0'
